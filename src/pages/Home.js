...
import { Switch, TextField, Card, CardActions, CardContent, AppBar, Fab, Tabs, Tab, Container, List, ListItem, ListItemText, ListItemAvatar, Avatar, Typography, Divider, LinearProgress, IconButton, Toolbar, Paper, Button, Dialog, DialogTitle, DialogContent, DialogActions, DialogContentText, BottomNavigation, BottomNavigationAction } from '@mui/material';
  ...
  function sanitizeTime(mins) {
    ...
    function getTaskCards() {
      return tasks
        ...
        .map(task => {return <TaskCard task={task}/>})
    }
